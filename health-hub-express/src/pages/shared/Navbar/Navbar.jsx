...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-100 shadow-sm px-4">
            {/* Using Helmet for the default page title in the navbar context */}
            <Helmet>
            ...
            {/* Desktop Navigation - HIDDEN on mobile screens (`hidden`) */}
            {/* This div will only be visible on large screens (`lg:flex`) */}
            ...
            <div className="navbar-end space-x-2">
                {/* Cart Icon (Desktop Only) - HIDDEN on mobile (`hidden`) */}
